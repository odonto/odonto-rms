...
SECRET_KEY = 'msj16cbwg^yxyweqt6kv$o$u(l#p@nf5en!g1@y=^aojq)zbdv'
...
COVERAGE_EXCLUDE_MODULES = ('rms.migrations', 'rms.tests',
                            'rms.local_settings',
